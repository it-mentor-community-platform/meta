...
Telegram id автора узнаем из заголовка.
...
Telegram id автора ревью узнаем из заголовка.
...
Используется для уведомления других сервисов о создании нового ревью.
