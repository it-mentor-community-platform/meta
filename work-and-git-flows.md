...
- Взяв задачу в работу, разработчик создаёт ветку. Сделать это можно через интерфейс GitHub нажав на ссылку "Create a branch" на странице назначенной задачи, в блоке Development боковой панели.
